...
<body class="no-transition">
        ...
        <img src="<?php echo $imagen; ?>" 
            ...
            <div class="box d-flex justify-content-center flex-column shadow-lg px-3 mt-4">
              ...
              <div class="d-flex justify-content-between align-items-center mt-4">
                <form class="input-group search-bar" style="max-width: 526px">
                    <input 
                        type="text" 
                        id="searchInput"
                ...
                <div class="filters-container d-flex justify-content-between align-items-center pt-2">
                        <!-- Filtros -->
    ...
    <option value="Femenino">Femenino</option>
                             ...
                             // seleción de la edad
                                for ($i = 18; $i <= 65; $i++) {
                                    echo "<option value='$i'" . ($filtroEdad == $i ? ' selected' : '') . ">$i</option>";
                                }
                            ?>
                                 </select>
                            ...
                            <button id="btn-filter" class="filter" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" class="bi bi-filter" viewBox="0 0 16 16">
                              <path d="M6 10.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5m-2-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5m-2-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5"/>
                            </svg></button>
                        </form>


                        <!-- Botón para agregar Docentes-->
                        <a href="#" id="btn-addDocente" class="btn-add d-flex justify-content-center align-items-center gap-3 text-white" data-bs-toggle="modal" data-bs-target="#modal-addDocente" style="width: 19.5%" >Agregar Docentes<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#fff" class="bi bi-plus-circle" viewBox="0 0 16 16">
                    ...
                    <div class="table-responsive">
                        <table id="tabla-docentes" class="table rounded-5 mt-4">
...
<?php include '../modales/Docente/modal-addDocente.php'; ?>
<?php include '../modales/Docente/modal-deleteDocente.php'; ?>
<?php include '../modales/Docente/modal-desinscribirDocente.php'; ?>
<?php include '../modales/Docente/modal-editDocente.php'; ?>
<?php include '../modales/Docente/modal-viewDocente.php'; ?>
<?php include '../modales/Docente/modal-AsignarCursoDocente.php'; ?>
    ...
    <script src="../../assets/js/Docente/tabla-docentes.js"></script>
    <script src="../../assets/js/Docente/editarDocente.js"></script>
    <script src="../../assets/js/Docente/asignarCursoDocente.js"></script>
    <script src="../../assets/js/Docente/eliminarDocente.js"></script>
    <script src="../../assets/js/Docente/viewDocente.js"></script>
    <script src="../../assets/js/Docente/paginacionDocente.js"></script>
    <script src="../../assets/js/Docente/filtrosDocente.js"></script>
    <script src="../../assets/js/Docente/buscarDocente.js"></script>
